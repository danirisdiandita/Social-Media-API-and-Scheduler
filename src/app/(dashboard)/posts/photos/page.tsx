...
const PhotoPostPage = () => {
  ...
  const simulatedErrorCode: RestrictionCode | null = null;
        ...
        <div className="flex items-center gap-4 p-4 border-b-4 border-black">
          ...
          <div>
            <h1 className="text-2xl font-black">
              {postSuccess ? "Post Successful!" : "Create Photo Post"}
            </h1>
            ...
            <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="flex-1 w-full space-y-6">
                  ...
                  {connections.length === 0 ? (
                    <div className="p-8 border-4 border-black text-center bg-white">
                      <p className="font-bold">
                        No connections available. Please connect your social
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                        {connections.map((connection: any) => (
                          ...
                          >
                            ...
                            {connection.username && (
                              <p className="text-[10px] font-bold text-gray-600 truncate lowercase">
                                @{connection.username}
                              </p>
                            )}
                ...
                {selectedConnections.filter(
                  (id: string) => connectionDetails[id],
                ).length > 0 && (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <div className="w-14 h-14 border-4 border-black overflow-hidden shrink-0">
                                <img
                                  src={
                                    info.creator_avatar_url || conn?.avatarUrl
                                  }
                                  ...
                                  {interactionSettings[id]
                                    ...
                                    <div className="mt-3 space-y-4">
                                      ...
                                      <p className="text-[11px] font-medium leading-tight text-gray-600">
                                        Turn on to disclose that this photo
                                        promotes goods or services in exchange
                                        for something of value. Your photo could
                                        promote yourself, a third party, or
                                        both.
                                      </p>
                                      ...
                                      <div className="space-y-4 pt-1">
                                        ...
                                        >
                                          ...
                                          <div>
                                            <p className="text-[11px] font-black uppercase group-hover:text-blue-600 transition-colors">
                                              Your brand
                                            </p>
                                            <p className="text-[10px] font-medium text-gray-500 leading-tight">
                                              You are promoting yourself or your
                                              own business. This photo will be
                                          ...
                                          <Tooltip>
                                            <TooltipTrigger asChild>
                                              ...
                                              >
                                                ...
                                                <div>
                                                  <p
                                                    className={`text-[11px] font-black uppercase ${!(privacySelections[id]?.toUpperCase() === "SELF" || privacySelections[id]?.toUpperCase() === "PRIVATE" || privacySelections[id]?.toUpperCase() === "ONLY_ME") && "group-hover:text-blue-600"} transition-colors`}
                                                  >
                                                    Branded content
                                                  </p>
                                                  <p className="text-[10px] font-medium text-gray-500 leading-tight">
                                        ...
                                        !interactionSettings[id]
                                          ...
                                          <div className="p-2 border-2 border-black bg-yellow-100 text-[9px] font-black uppercase text-yellow-800 leading-tight flex items-center gap-2">
                                            ...
                                            <span>
                                              ...
                                              selected to proceed. You need to
                                              indicate if your content promotes
                            ...
                            <div className="mt-auto pt-2 border-t-2 border-black border-dashed flex flex-col gap-1">
                              <p className="text-[9px] font-bold text-blue-600 leading-tight italic">
                                * This is a photo post. Platform-specific
                                duration checks not applicable.
                              </p>
                            </div>
                          </div>
                        );
                ...
                <p className="text-[10px] font-bold text-gray-500 mb-2 text-right uppercase italic">
                  <div className="mt-2 text-xs font-bold bg-[#A6FAFF] border-2 border-black p-3">
                    {selectedConnections.some(
                      ...
                      <>
                        By posting, you expressly consent to send your content
                        to TikTok and agree to TikTok&apos;s{" "}
                        <a
                          href="https://www.tiktok.com/legal/page/global/bc-policy/en"
                          target="_blank"
                          rel="noopener noreferrer"
                  ...
                  <TooltipProvider>
                    <Tooltip delayDuration={0}>
                      ...
                      {selectedConnections.some((id) => {
                        const isSelfPrivate =
                          privacySelections[id] &&
                          (privacySelections[id].toUpperCase() === "SELF" ||
                  ...
                  {previewPhoto ? (
                    <div className="space-y-4">
                      ...
                      <div className="p-4 border-4 border-black bg-yellow-100 italic font-bold text-sm leading-tight">
                        ...
                        <p className="mt-2 text-[10px] uppercase opacity-70">
                          🎯 This is how your photo will appear in the post
                          gallery.
                        </p>
                      </div>
                    ...
                    <div className="aspect-[9/16] border-4 border-black border-dashed bg-gray-50 flex flex-col items-center justify-center text-center p-8 gap-4 grayscale opacity-40">
                      ...
                      <p className="text-[10px] font-bold">
                        Upload images and click one to see it here
                      </p>
                    </div>
                  )}
                </div>
